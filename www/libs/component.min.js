...
parentElement[scriptElement.getAttribute('id')]=component;Component.compiler.copyAttributes(scriptElement,component,['type','source']);parentElement.replaceChild(component,scriptElement);}else{Component.loader.wrapPathToElement({path:path,async:function(component){if(scriptElement.getAttribute('id'))
